...
void print_limits(void)
{
	...
	do_limit(RLIMIT_SIGPENDING, "RLIMIT_SIGPENDING", &rlim);
	do_limit(RLIMIT_MSGQUEUE, "RLIMIT_MSGQUEU", &rlim);
	do_limit(RLIMIT_NICE, "RLIMIT_NICE", &rlim);
	do_limit(RLIMIT_RTPRIO, "RLIMIT_RTPRIO", &rlim);
}
